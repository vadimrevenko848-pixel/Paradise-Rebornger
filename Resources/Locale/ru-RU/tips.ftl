...
tips-dataset-139 = Не забывайте очищать свои нелегальные импланты мылом или влажной тряпкой после использования! Детективы могут сканировать использованные имплантеры на наличие улик ДНК, но только если они не были тщательно протерты.
