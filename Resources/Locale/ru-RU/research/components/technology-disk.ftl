...
tech-disk-examine-desc = [color=lightGray]Диск для сервера РнД, содержащий технологию ветки [bold]{ $branch } { $tier }-го уровня[/bold].[/color]
tech-disk-examine-desc-unknown = [color=lightGray]Диск для сервера РнД, содержащий технологию исследования.[/color]
