...
voice-mask-name-change-toggle = Переключить маскировку голоса
voice-mask-name-change-accent-toggle = Блокировать акцент

voice-mask-popup-toggle = Маскировка голоса переключена.
voice-mask-popup-accent-toggle = Режим акцента переключен.
