...
ent-DisposalRouterFlipped = { ent-DisposalRouter }
    .desc = Трёхходовой разделитель. Объекты с подходящими тегами направляются в сторону.
    .suffix = Перевёрнутый
...
ent-DisposalJunctionFlipped = { ent-DisposalJunction }
    .desc = Трёхходовой соединитель. Стрелка указывает направление выхода предметов.
    .suffix = Перевёрнутый
