ent-TravelCamera = походный фотоаппарат
    .desc = Снимок скажет больше тысячи слов. Поставляется со сверхъяркой вспышкой и встроенной самозаряжающейся фотоплёнкой.
