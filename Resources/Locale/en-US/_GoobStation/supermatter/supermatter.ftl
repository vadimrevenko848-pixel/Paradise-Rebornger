...
supermatter-examine-integrity = It's integrity is [color=yellow]{$integrity}%[/color].
...
supermatter-announcement-cc-tamper = Our automatic casualty system has detected that the supermatter crystal structural integrity was compromised by an external force.
